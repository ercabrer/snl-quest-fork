...
set VENV_PATH=%~dp0..\..\..\app_envs\env_calculator

REM Set the path to the setup.py file
set SETUP_PATH=%~dp0..\..\..\app_envs\env_calculator\snl_quest_calculator

set calculator_dir=snl_quest_progress
python -m venv %VENV_PATH%
call "%VENV_PATH%\Scripts\activate"

mkdir "%VENV_PATH%\%calculator_dir%"
